...
<template>
  <div class="login_form p-6">
    <header class="login_header flex items-center">
      <span class="login_type_title" :class="{ login_type_title_active: titleActive == 1 }" @click="titleActive = 1">
        免密登录
      </span>
      <span
        class="login_type_title ml-4"
        :class="{ login_type_title_active: titleActive == 2 }"
        @click="titleActive = 2">
        密码登录
      </span>
